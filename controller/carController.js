...
const createCar = async (req, res, next) => {
    ...
    try {
        ...
        const createdByUser = await User.findByPk(
            req.user.id
        );
...
const updateCar = async (req, res, next) => {
    ...
    try {
        ...
        const [updatedRowCount, [updatedCar]] =
            await Car.update(
                {
                    name,
                    price,
        ...
        const updateByUser = await User.findByPk(
            req.user.id
        );
